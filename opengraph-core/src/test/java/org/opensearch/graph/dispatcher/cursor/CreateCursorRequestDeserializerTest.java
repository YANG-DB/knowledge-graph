...
public class CreateCursorRequestDeserializerTest {
    ...
    public static void setup() {
        ...
        module.addDeserializer(CreateCursorRequest.class, new CreateCursorRequestDeserializer(
                Stream.of(
                        new CompositeCursorFactory.Binding(CreatePathsCursorRequest.CursorType, CreatePathsCursorRequest.class, null),
                        new CompositeCursorFactory.Binding(CreateGraphCursorRequest.CursorType, CreateGraphCursorRequest.class, null),
                        new CompositeCursorFactory.Binding(CreateGraphQLCursorRequest.CursorType, CreateGraphQLCursorRequest.class, null),
                        new CompositeCursorFactory.Binding(CreateGraphHierarchyCursorRequest.CursorType, CreateGraphHierarchyCursorRequest.class, null))
                .toJavaList()));
