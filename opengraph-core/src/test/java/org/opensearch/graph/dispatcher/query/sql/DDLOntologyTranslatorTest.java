...
public class DDLOntologyTranslatorTest {
    ...
    public static void setUp() throws Exception {
        ...
        config.put(String.format("%s.%s","test", DDLToOntologyTransformer.RELATIONSHIPS),Arrays.asList("book_to_book_store"));
        config.put(String.format("%s.%s","test", DDLToOntologyTransformer.ENTITIES),Arrays.asList("book","book_store","author","language"));
