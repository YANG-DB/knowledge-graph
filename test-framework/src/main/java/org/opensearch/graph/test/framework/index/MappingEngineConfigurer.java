...
public class MappingEngineConfigurer implements EngineIndexConfigurer {
    //region Constructors
    public MappingEngineConfigurer(String indexName, Map<String, Object> mappings) {
        this(Collections.singletonList(indexName), mappings);
    }

    public MappingEngineConfigurer(Iterable<String> indices, Map<String, Object> mappings) {
        this.indices = Stream.ofAll(indices).toJavaSet();
        this.mappings = mappings;
    }

    public MappingEngineConfigurer(String index, Mappings mappings) throws IOException {
        this(Collections.singletonList(index), mappings);
    }

    public MappingEngineConfigurer(Iterable<String> indices, Mappings mappings) throws IOException {
