...
public class EngineIndexProviderMappingFactory implements OntologyIndexGenerator {
    ...
    @Inject
    public EngineIndexProviderMappingFactory(Client client, RawSchema schema, Ontology ontology, IndexProvider indexProvider) {
        this.client = client;
        this.schema = schema;
    ...
    public EngineIndexProviderMappingFactory indexProvider(IndexProvider indexProvider) {
        this.indexProvider = indexProvider;
        return this;
    }

    public EngineIndexProviderMappingFactory ontology(Ontology ontology) {
        this.ontology = ontology;
        return this;
    }
