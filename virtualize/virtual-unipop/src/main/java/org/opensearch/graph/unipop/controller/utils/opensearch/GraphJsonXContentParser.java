...
public class GraphJsonXContentParser extends AbstractGraphXContentParser {

    final JsonParser parser;
    private DeprecationHandler deprecationHandler;

    public GraphJsonXContentParser(NamedXContentRegistry xContentRegistry, DeprecationHandler deprecationHandler, JsonParser parser) {
