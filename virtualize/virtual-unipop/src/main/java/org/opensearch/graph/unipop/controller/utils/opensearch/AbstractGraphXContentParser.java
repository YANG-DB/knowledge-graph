...
public abstract class AbstractGraphXContentParser implements XContentParser {
    ...
    public AbstractGraphXContentParser(NamedXContentRegistry xContentRegistry) {
    ...
    static final AbstractGraphXContentParser.MapFactory SIMPLE_MAP_FACTORY = HashMap::new;

    static final AbstractGraphXContentParser.MapFactory ORDERED_MAP_FACTORY = LinkedHashMap::new;

    static final AbstractGraphXContentParser.MapStringsFactory SIMPLE_MAP_STRINGS_FACTORY = HashMap::new;

    static final AbstractGraphXContentParser.MapStringsFactory ORDERED_MAP_STRINGS_FACTORY = LinkedHashMap::new;
    ...
    static Map<String, Object> readMap(XContentParser parser, AbstractGraphXContentParser.MapFactory mapFactory) throws IOException {
    ...
    static Map<String, String> readMapStrings(XContentParser parser, AbstractGraphXContentParser.MapStringsFactory mapStringsFactory) throws IOException {
    ...
    static List<Object> readList(XContentParser parser, AbstractGraphXContentParser.MapFactory mapFactory) throws IOException {
        XContentParser.Token token = parser.currentToken();
        if (token == null) {
            token = parser.nextToken();
        }
    ...
    static Object readValue(XContentParser parser, AbstractGraphXContentParser.MapFactory mapFactory, XContentParser.Token token) throws IOException {
