...
import org.opensearch.graph.epb.plan.statistics.EngineCountStatisticsProviderFactory;
    ...
    protected void bindCostEstimator(Env env, Config conf, Binder binder) {
        binder.install(new PrivateModule() {
            ...
            protected void configure() {
                ...
                this.bind(StatisticsProviderFactory.class).to(EngineCountStatisticsProviderFactory.class).asEagerSingleton();
