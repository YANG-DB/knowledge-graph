...
public class EngineStatisticsGraphProvider implements GraphStatisticsProvider {
    ...
    //region Constructors
    @Inject
    public EngineStatisticsGraphProvider(StatConfig config,
                                         EngineStatProvider engineStatProvider,
                                         Cache<Tuple2<String, List<String>>, List<Statistics.BucketInfo>> cache) {
        this.statConfig = config;
        this.engineStatProvider = engineStatProvider;
        this.cache = cache;
    }
    //endregion
    ...
    public <T extends Comparable<T>> Statistics.HistogramStatistics<T> getConditionHistogram(GraphElementSchema graphElementSchema,
        ...
        Map<String, List<Statistics.BucketInfo>> fieldStatisticsPerIndex = this.engineStatProvider.getFieldStatisticsPerIndex(
                relevantIndices,
    ...
    public long getGlobalSelectivity(GraphEdgeSchema graphEdgeSchema,
        ...
        List<Statistics.BucketInfo<String>> buckets = this.engineStatProvider.getEdgeGlobalStatistics(
                relevantIndices,
                Collections.singletonList(constraintLabel),
    ...
    private List<Statistics.BucketInfo> getBuckets(String docType, List<String> indices) {
        return cache.get(new Tuple2<>(docType, indices),
                stringListTuple2 -> engineStatProvider.getFieldStatistics(
                        indices,
    ...
    private final EngineStatProvider engineStatProvider;
