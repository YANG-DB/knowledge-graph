...
/*-
 *
 * QueryDescriptor.java - opengraph-model - yangdb - 2,016
...
import static org.opensearch.graph.model.query.Query.QueryUtils.findByEnum;
import static org.opensearch.graph.model.query.Query.QueryUtils.getPath;
