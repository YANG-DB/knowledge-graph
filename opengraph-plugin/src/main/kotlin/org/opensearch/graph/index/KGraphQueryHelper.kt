...
import org.opensearch.graph.model.RestTag.NAME_FIELD
 ...
 */
internal class KGraphQueryHelper(private val types: EnumSet<ObjectType>) {
    companion object {
        ...
        // keyword and text fields are under KGraphObject  and should be prepended with type
        ...
        private val OBJECT_FIELDS = KEYWORD_FIELDS.union(TEXT_FIELDS)
        private val ALL_FIELDS = METADATA_FIELDS.union(OBJECT_FIELDS)
