 ...
 */
internal class QueryInfoObjectResponse : BaseResponse {
    ...
    companion object {
         ...
         */
        val reader = Writeable.Reader { QueryInfoObjectResponse(it) }
        ...
        fun parse(parser: XContentParser): QueryInfoObjectResponse {
            return QueryInfoObjectResponse(ObjectSearchResult(parser), false)
        }
    }
