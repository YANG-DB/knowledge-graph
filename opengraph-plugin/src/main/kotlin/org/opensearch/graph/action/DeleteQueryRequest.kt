 ...
 */
internal class DeleteQueryRequest : ActionRequest, ToXContentObject {
    val objectIds: Set<String>

    companion object {
        private val log by logger(DeleteQueryRequest::class.java)

        /**
         * reader to create instance of class from writable.
         */
        val reader = Writeable.Reader { DeleteQueryRequest(it) }
        ...
        fun parse(parser: XContentParser): DeleteQueryRequest {
            ...
            return DeleteQueryRequest(objectIds)
        }
    }
