 ...
 */
internal class GenericObjectRequest : ActionRequest, ToXContentObject {
    val objectIds: Set<String>

    companion object {
        private val log by logger(GenericObjectRequest::class.java)

        /**
         * reader to create instance of class from writable.
         */
        val reader = Writeable.Reader { GenericObjectRequest(it) }
        ...
        fun parse(parser: XContentParser): GenericObjectRequest {
            ...
            return GenericObjectRequest(objectIds)
        }
    }

    /**
     * constructor for creating the class
     * @param objectIds the id of the KGraphObject
     */
