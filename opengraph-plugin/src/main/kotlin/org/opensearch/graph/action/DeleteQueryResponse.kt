...
import org.opensearch.graph.model.RestTag.DELETE_RESPONSE_LIST_TAG
 ...
 */
internal class DeleteQueryResponse : BaseResponse {
    val objectIdToStatus: Map<String, RestStatus>

    companion object {
        private val log by logger(DeleteQueryResponse::class.java)

        /**
         * reader to create instance of class from writable.
         */
        val reader = Writeable.Reader { DeleteQueryResponse(it) }
        ...
        fun parse(parser: XContentParser): DeleteQueryResponse {
            ...
            return DeleteQueryResponse(objectIdToStatus)
        }
     ...
     * @param objectIdToStatus the ids of the deleted KGraphObject with status
     */
