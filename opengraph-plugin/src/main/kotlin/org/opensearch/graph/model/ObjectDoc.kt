...
import org.opensearch.graph.model.ObjectDataProperties.getReaderForObjectType
import org.opensearch.graph.model.RestTag.ACCESS_LIST_FIELD
import org.opensearch.graph.model.RestTag.CREATED_TIME_FIELD
import org.opensearch.graph.model.RestTag.OBJECT_ID_FIELD
import org.opensearch.graph.model.RestTag.TENANT_FIELD
import org.opensearch.graph.model.RestTag.UPDATED_TIME_FIELD
...
data class ObjectDoc(
    ...
    companion object {
        private val log by logger(ObjectDoc::class.java)

        /**
         * reader to create instance of class from writable.
         */
        val reader = Writeable.Reader { ObjectDoc(it) }
        ...
        fun parse(parser: XContentParser, useId: String? = null): ObjectDoc {
            ...
            while (parser.nextToken() != XContentParser.Token.END_OBJECT) {
                ...
                when (fieldName) {
                    ...
                    ACCESS_LIST_FIELD -> access = parser.stringList()
                        ...
                        if (objectTypeForTag != ObjectType.NONE && objectData == null) {
                            objectData =
                                ObjectDataProperties.createObjectData(objectTypeForTag, parser)
            ...
            return ObjectDoc(objectId, updatedTime, createdTime, tenant, access, type, objectData)
        }
    }
    ...
    constructor(input: StreamInput) : this(
        ...
        objectData = input.readOptionalWriteable(getReaderForObjectType(input.readEnum(ObjectType::class.java)))
    )
