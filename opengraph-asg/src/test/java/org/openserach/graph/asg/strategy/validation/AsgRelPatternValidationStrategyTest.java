...
import org.openserach.graph.asg.validation.AsgEntityPropertiesValidatorStrategy;
import org.openserach.graph.asg.validation.AsgRelPatternValidatorStrategy;
...
@Ignore
/**
 * AsgRelPatternValidatorStrategy - test AsgRelPatternValidatorStrategy
 */
public class AsgRelPatternValidationStrategyTest {
    Ontology ontology;
    ...
    public void testValidQuery() {
        AsgRelPatternValidatorStrategy strategy = new AsgRelPatternValidatorStrategy();
    ...
    public void testNotValidPropEntityMismatchQuery() {
        ...
        Assert.assertTrue(Stream.ofAll(validationResult.errors()).toJavaArray(String.class)[0].contains(AsgRelPatternValidatorStrategy.ERROR_2));
    }
