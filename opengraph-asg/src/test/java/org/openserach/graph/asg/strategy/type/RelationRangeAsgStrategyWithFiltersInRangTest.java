 ...
 * -[:R]->(:E)-[:R]->(:E)-[:R]->(:E)
 */
public class RelationRangeAsgStrategyWithFiltersInRangTest {
    ...
    public void testUntypedToTypedStrategyWithoutQuantsInPath() {
        ...
        Assert.assertEquals(3, AsgQueryUtil.elements(query, QuantBase.class).stream().filter(e->e.getNext().size()==2).count());
        ...
        Assert.assertEquals(10, AsgQueryUtil.count(quant.get().getNext().get(1), EBase.class));
        Assert.assertEquals(15, AsgQueryUtil.count(quant.get().getNext().get(2), EBase.class));
        ...
        Assert.assertEquals(6, AsgQueryUtil.elements(query, EPropGroup.class).size());
    ...
    public void testUntypedToTypedWithPropsStrategyWithoutQuantsInPath() throws Exception {
        ...
        Assert.assertEquals(0, AsgQueryUtil.elements(query, QuantBase.class).stream().filter(e->e.getNext().size()==1).count());
        ...
        Assert.assertEquals(16, AsgQueryUtil.count(quant.get().getNext().get(2), EBase.class));
    ...
    public void testUntypedToTypedWithPropsStrategyWithoutQuantsInPathWithRangeFromZero() throws Exception {
        ...
        Assert.assertEquals(16, AsgQueryUtil.count(quant.get().getNext().get(3), EBase.class));
    ...
    public void testUntypedToTypedWithSomePropsStrategyWithoutQuantsInPath() throws Exception {
        ...
        Assert.assertEquals(3, quant.get().getNext().size());
        Assert.assertEquals(1, AsgQueryUtil.elements(query, QuantBase.class).stream().filter(e->e.getNext().size()==3).count());
        Assert.assertEquals(7, AsgQueryUtil.elements(query, QuantBase.class).stream().filter(e->e.getNext().size()==2).count());
        Assert.assertEquals(0, AsgQueryUtil.elements(query, QuantBase.class).stream().filter(e->e.getNext().size()==1).count());
    ...
    public void testUntypedToTypedWithQuantPropsStrategyWithoutQuantsInPath() throws Exception {
        ...
        Assert.assertEquals(9, AsgQueryUtil.elements(query, EPropGroup.class).stream().filter(ep -> ep.geteBase().getProps().size() == 1).count());
        Assert.assertEquals(0, AsgQueryUtil.elements(query, EProp.class).size());
    ...
    @Test
    @Ignore ( "Fix when both relPattern->relProp && endPattern->filter exist togather")
    public void testUntypedToTypedWithQuantPropsAfterRelStrategyWithoutQuantsInPath() throws Exception {
        ...
        Assert.assertTrue(quant.isPresent());
        Assert.assertEquals(3, quant.get().getNext().size());
        Assert.assertEquals(4, AsgQueryUtil.elements(query, QuantBase.class).stream().filter(e->e.getNext().size()==3).count());
        Assert.assertEquals(6, AsgQueryUtil.elements(query, QuantBase.class).stream().filter(e->e.getNext().size()==2).count());
        Assert.assertEquals(0, AsgQueryUtil.elements(query, QuantBase.class).stream().filter(e->e.getNext().size()==1).count());

        Assert.assertEquals(8, AsgQueryUtil.count(quant.get().getNext().get(0), EBase.class));
    ...
    public void testUntypedToTypedWithPropsStrategyWithQuantsInPath() {
        ...
        Assert.assertEquals(3, AsgQueryUtil.elements(query, EProp.class).stream().filter(ep -> ep.geteBase().getCon().getOp().equals(eq)).count());
        Assert.assertEquals(7, AsgQueryUtil.elements(query, EPropGroup.class).size());
