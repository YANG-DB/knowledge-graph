...
public class LoggingSqlController extends LoggingControllerBase<SchemaTranslatorController> implements SchemaTranslatorController {
    public static final String controllerParameter = "LoggingSqlController.@controller";
    public static final String loggerParameter = "LoggingSqlController.@logger";

    //region Constructors
    @Inject
    public LoggingSqlController(
