...
public interface QueryController<C,D> extends Controller<C,D> {
     ...
     * @return
     */
    ContentResponse<Object> runOntologyQuery(Query query, int pageSize, String cursorType);
...
//    ContentResponse<Object> runSparql(String sparql, String ontology, int pageSize, String cursorType);
    ...
    /**
     * get OQL query for a given query
     * @param queryId
     * @return
     */
    ContentResponse<Query> getOQL(String queryId);
    /**
    ...
    /**
     * get the plan generated by the OQL query
     * @param query
     * @return
     */
