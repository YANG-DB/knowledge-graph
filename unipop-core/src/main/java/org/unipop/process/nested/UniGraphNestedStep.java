package org.unipop.process.nested;
...
public class UniGraphNestedStep extends UniPredicatesStep<Edge, Vertex> implements Orderable, Profiling {
    ...
    public UniGraphNestedStep(Traversal.Admin traversal, Direction direction, UniGraph graph, ControllerManager controllerManager) {
