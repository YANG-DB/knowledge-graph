...
public class InitEntitiesTest {
    ...
    public static void setUp() throws IOException {
        settings = Map.of("Log", new EntityConfigurationBase(new Properties(), 100, 20),
                "Span", new EntityConfigurationBase(new Properties(), 50, 10)
        );
