...
public interface FireEdge {
    static void main(String args[]) throws IOException {
        ...
        RedundantFieldTransformer redundantFieldTransformer = new RedundantFieldTransformer(ETLUtils.getClient(),
                ETLUtils.redundant(ETLUtils.FIRE, Direction.out,"A"),
                ...
                ETLUtils.DRAGON,
                ETLUtils.redundant(ETLUtils.FIRE, Direction.out,"B"),
        ...
        IdFieldTransformer idFieldTransformer = new IdFieldTransformer(ETLUtils.ID, ETLUtils.DIRECTION_FIELD, ETLUtils.FIRE);
        ...
        FileTransformer transformer = new FileTransformer("C:\\demo_data_6June2017\\dragonsRelations_FIRES.csv",
                ...
                chainedTransformer,
                Arrays.asList(ETLUtils.ID, ETLUtils.ENTITY_A_ID, ETLUtils.ENTITY_B_ID, ETLUtils.START_DATE, ETLUtils.DURATION),
                5000);
