...
public interface RegisteredInEdge {
    static void main(String args[]) throws IOException {
        ...
        outConstFields.put(ETLUtils.ENTITY_A_TYPE, ETLUtils.GUILD);
        ...
        inConstFields.put(ETLUtils.ENTITY_B_TYPE, ETLUtils.GUILD);
        ...
        RedundantFieldTransformer redundantOutTransformer = new RedundantFieldTransformer(ETLUtils.getClient(),
                ETLUtils.redundant(ETLUtils.REGISTERED, out, "A"),
                ...
                ETLUtils.GUILD,
                ETLUtils.redundant(ETLUtils.REGISTERED, out,"B"),
        ...
        RedundantFieldTransformer redundantInTransformer = new RedundantFieldTransformer(ETLUtils.getClient(),
                ETLUtils.redundant(ETLUtils.REGISTERED,  Direction.in, "A"),
                ETLUtils.ENTITY_A_ID,
                Stream.ofAll(ETLUtils.indexPartition(ETLUtils.KINGDOM).getPartitions()).flatMap(IndexPartitions.Partition::getIndices).toJavaList(),
                ETLUtils.KINGDOM,
                ETLUtils.redundant(ETLUtils.REGISTERED, Direction.in,"B"),
                ETLUtils.ENTITY_B_ID,
                Stream.ofAll(ETLUtils.indexPartition(ETLUtils.GUILD).getPartitions()).flatMap(IndexPartitions.Partition::getIndices).toJavaList(),
                ETLUtils.GUILD, Direction.in.name());
        ...
        IdFieldTransformer idFieldTransformer = new IdFieldTransformer(ETLUtils.ID, ETLUtils.DIRECTION_FIELD, ETLUtils.REGISTERED );
