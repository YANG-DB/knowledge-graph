...
public interface OwnHorseEdge {
    static void main(String args[]) throws IOException {
        ...
        outConstFields.put(ETLUtils.ENTITY_B_TYPE, ETLUtils.HORSE);
        ...
        inConstFields.put(ETLUtils.ENTITY_A_TYPE, ETLUtils.HORSE);
        ...
        IdFieldTransformer idFieldTransformer = new IdFieldTransformer(ETLUtils.ID, ETLUtils.DIRECTION_FIELD, ETLUtils.OWN + "H");
