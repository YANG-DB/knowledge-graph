...
public class DragonsSmartEpbTest7Setup extends TestSetupBase  {
    public static void main(String[] args) throws Exception {
        DragonsSmartEpbTest7Setup test = new DragonsSmartEpbTest7Setup();
        DragonKingdomQuery7Test dragonKingdomQueryTest = new DragonKingdomQuery7Test();
        TestRunner.run(dragonKingdomQueryTest, test,"m1.rule.dfs.redundant","m1.dfs.redundant");
    }
