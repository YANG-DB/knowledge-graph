...
public class DragonKingdomQuery3Test extends TestCase {
    ...
    public void run(GraphClient GraphClient) throws Exception {
        ...
        Query query = Query.Builder.instance().withName(NAME.name).withOnt(ont.name()).withElements(Arrays.asList(
                ...
                new EProp(7, NAME.type, Constraint.of(ConstraintOp.eq, "B")),
                ...
                new EConcrete(11, "E", ont.eType$(OntologyTestUtils.DRAGON.name), "Dragon_1", "D0", 0, 0)
        )).build();
