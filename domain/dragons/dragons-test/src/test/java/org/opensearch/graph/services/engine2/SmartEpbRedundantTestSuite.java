...
import org.opensearch.graph.services.engine2.data.SmartEpbRedundantEntityRelationEntityIT;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({
        SmartEpbRedundantEntityRelationEntityIT.class
})
public class SmartEpbRedundantTestSuite implements BaseSuiteMarker {
    @BeforeClass
    ...
    public static void cleanup() throws Exception {
        ...
        System.out.println("SmartEpbRedundantTestSuite elapsed: " + elapsed);
    }
