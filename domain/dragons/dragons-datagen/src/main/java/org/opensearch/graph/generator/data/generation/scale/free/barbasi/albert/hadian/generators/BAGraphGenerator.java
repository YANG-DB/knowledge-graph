package org.opensearch.graph.generator.data.generation.scale.free.barbasi.albert.hadian.generators;
...
import org.opensearch.graph.generator.data.generation.scale.free.barbasi.albert.hadian.roulettes.*;
import org.opensearch.graph.generator.data.generation.scale.free.barbasi.albert.hadian.roulettes.*;
...
//        generator.createGraph();
    ...
    public static List<Tuple2> generateMassiveBAgraph(int numOfNodes, int edgesPerNode, SamplingMode samplingMode, String filePath){
        try {
            ...
            BAGraphGenerator.graphFileWriter = new BufferedWriter(new FileWriter(filePath));
